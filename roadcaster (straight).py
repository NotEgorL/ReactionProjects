...
screen = pygame.display.set_mode((WIDTH, HEIGHT), FULLSCREEN, pygame.RESIZABLE)
# Title
pygame.display.set_caption("SPEEEEEEEEEEEEd")

plane_center_x = WIDTH//2

# signs
sign1STOP = pygame.image.load("stop.png").convert()
...
"""for a good time"""
# player_car=pygame.image.load('1.jpg').convert_alpha()
player_car = pygame.image.load('player_car.png').convert_alpha()
"""end"""
player_car = pygame.transform.scale(player_car, (160, 100))
ground = pygame.Surface((1280, 800)).convert()
ground.fill((0, 100, 0))
resolution = 1
...
#############################set_allowed(typelist->bool
pygame.key.set_repeat(400, 30)
try:
    # catch error from middle mouse exit
    while True:
        # how many loops a second. fps
        CLOCK.tick(32)
        ...
        while wall_bottom > plane_center+10:
            ...
            slice_x = (plane_center_x)-(slice_width//2)
            dx = slice_x
            ...
            screen.blit(player_car, (400, 350))
            screen.blit(sign1STOP, (250, 20)) #640,480S
